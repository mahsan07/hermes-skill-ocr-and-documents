---
name: hermes-skill-ocr-and-documents
description: Extract text and structure from PDFs and scans using OCR and document parsers. Use when the user explicitly requests this capability or a closely related task.
---
