...
- **PDF or scanned images**
- **Page rasterizer**
- **OCR and layout detector**
- **Structured text normalizer**
- **Searchable export**
...
This repository now includes a typed, task-adaptive harness contract for **OCR and Documents**. The contract maps the skill to memory, planning, capability-orchestration, and action modules; defines bounded repair and stop behavior; and records skill-specific verification evidence.
